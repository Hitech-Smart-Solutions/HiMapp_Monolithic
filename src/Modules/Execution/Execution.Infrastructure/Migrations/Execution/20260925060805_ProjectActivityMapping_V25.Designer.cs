...
namespace Himapp.Execution.Infrastructure.Migrations.Execution
{
    ...
    [Migration("20260925060805_ProjectActivityMapping_V25")]
    partial class ProjectActivityMapping_V25
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Himapp.Execution.Domain.Entities.ExecutionProjectConfig", b =>
                {
                    ...
                    b.Property<int>("DDLSBackDatedDays")
                        .HasColumnType("integer");

                    b.Property<bool>("DDLSDPRLinkage")
                        .HasColumnType("boolean");

                    b.Property<bool>("DPREntryContinue")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("PlanningRequired")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Himapp.Execution.Domain.Entities.LockRequest", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("LockRequest", "execution");
                });

            modelBuilder.Entity("Himapp.Execution.Domain.Entities.LockRequestDetails", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("LockRequestID");

                    b.ToTable("LockRequestDetails", "execution");
                });
            ...
            modelBuilder.Entity("Himapp.Execution.Domain.Entities.LockRequestDetails", b =>
                {
                    b.HasOne("Himapp.Execution.Domain.Entities.LockRequest", "LockRequest")
                        .WithMany("LockRequestDetails")
                        .HasForeignKey("LockRequestID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LockRequest");
                });
            ...
            modelBuilder.Entity("Himapp.Execution.Domain.Entities.LockRequest", b =>
                {
                    b.Navigation("LockRequestDetails");
                });
