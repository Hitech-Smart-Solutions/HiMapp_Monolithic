...
public sealed record DailyProgressForApprovalByIDModel
{
    ...
    public IReadOnlyCollection<DailyProgressDetailForApprovalModel> Details { get; init; }
        = Array.Empty<DailyProgressDetailForApprovalModel>();

    public IReadOnlyCollection<DailyProgressHindranceModel> Hindrances { get; init; }
